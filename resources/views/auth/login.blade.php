                ...
                <div class="account-wrapper">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group form-focus">
                            ...
                            <input class="form-control floating"  name="email" :value="old('email')" type="text">
                        </div>
                        <div class="form-group form-focus">
                            <label class="focus-label">Password</label>
                            <input class="form-control floating" name="password" type="password" placeholder="************" required autocomplete="current">
                        </div>
