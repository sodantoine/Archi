            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateslider">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4"> @if($newImage)
                                <img src="{{$newImage->temporaryUrl()}}" width="120"/>
                                                   @else
                                <img style="height: 50px" src="{{asset('assets/images/sliders')}}/{{$image}}">
                            @endif


                            <input type="file" placeholder="newImage" class="input-file" wire:model="newImage">
