            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if(\Illuminate\Support\Facades\Session::has('coupon'))
                        ...
                        <p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)</span><b class="index">${{number_format($taxeAfterdiscount,2)}}</b></p>
                   ...
                   @else
                    <p class="summary-info"><span class="title">Tax</span><b
                                class="index">${{\Gloudemans\Shoppingcart\Facades\Cart::tax()}}</b></p>
                    <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
                    <p class="summary-info total-info "><span class="title">Total</span><b
                                class="index">${{\Gloudemans\Shoppingcart\Facades\Cart::total()}}</b></p>
                    @endif
                </div>
                                ...
                                <form wire:submit.prevent="applyCouponCode">
                                    ...
                                    @if(\Illuminate\Support\Facades\Session::has('coupon_message'))
                                        <div class="alert alert-danger" role="danger">
                                            {{\Illuminate\Support\Facades\Session::get('coupon_message')}}
                                        </div>
                                    @endif
                                    <p class="row-in-form">
...
<div class="update-clear">
  <a style="margin-bottom: 5px" class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Clear Shopping Cart</a>
